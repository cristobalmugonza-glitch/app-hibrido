...
- **Proyección de la próxima semana.** Usa tu historial para proponer: tipo de semana, subir o bajar peso (doble progresión), sumar o quitar series donde un músculo quedó fuera del rango de su prioridad (hasta 2 series por semana), sacar un bloque si llevas 2 semanas bajo el 70 % de lo planificado, el running de la semana (km y su motivo, reparto en calidad, fondo y Z2, salto de km), ajuste de calorías y tests pendientes. Cada ajuste trae su "por qué".
...
- **Km de running.** El onboarding estima tus km semanales con los días que corres, tu salida normal y tu salida más larga del mes: (días − 1) × salida normal + la más larga. Con meta **Mejorar**, los km suben 8 % (al menos 1 km) si cumpliste el 80 % de tu última semana de carga, se repiten entre 50 y 80 % y bajan 10 % bajo 50 % (sin bajar de 2/3 de la base); con molestias de tobillo, rodilla o cadera no suben, y en descarga son el 60 %. Con meta **Mantener forma** quedan fijos, con al menos 2 salidas y 1 de calidad. Los km se reparten con el fondo como la salida larga, la calidad según sus repeticiones (+1 por semana de carga) y el resto en Z2. Semana y Progreso muestran el promedio real de 4 semanas.
- **Protocolo de tobillo.** Disponible en el catálogo (grupo tobillo): si tu plan lo incluye, esos ejercicios son obligatorios para cerrar la sesión y cada carrera parte con 2 × 30 s de equilibrio por lado.
